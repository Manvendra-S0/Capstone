...
#                       'Actual Detection Difference', 'Extra TRT Detection Locations', 'Extra TRT Class Labels', 'Significant Overlap']
#         writer = csv.DictWriter(out_file, fieldnames=fieldnames)
#         writer.writeheader()
...
#             trt_classes = eval(row.get('trt_classes'))  # Get the class labels for extra TRT detections

#             non_overlapping_boxes = []
#             non_overlapping_classes = []
...
#                 if not is_overlapping:
#                     non_overlapping_boxes.append(extra_box)
#                     non_overlapping_classes.append(extra_trt_classes[i])  # Store the class label

#             actual_detection_difference = len(non_overlapping_boxes)
...
#                 'Actual Detection Difference': actual_detection_difference,
#                 'Extra TRT Detection Locations': str(non_overlapping_boxes),
#                 'Extra TRT Class Labels': str(non_overlapping_classes),  # Store extra TRT class labels
#                 'Significant Overlap': 'No' if actual_detection_difference > 0 else 'Yes'
#             })

# # Path to the CSV file generated in the previous step
# csv_file_path = '/home/manvendra/Documents/yolo_tensorrt/extracted_videos/model_comparison_with_location_and_classes.csv'

# # Output CSV file to save the comparison results with IoU analysis
# output_csv_file_path = '/home/manvendra/Documents/yolo_tensorrt/extracted_videos/detection_comparison_iou_with_classes.csv'
